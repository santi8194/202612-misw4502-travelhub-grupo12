"""Add reservation cancellation audit table."""
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("politica_tipo", sa.String(length=40), nullable=True),
        ...
        sa.Column("pms_status", sa.String(length=30), nullable=True),
        sa.Column("cancellation_reference", sa.String(length=80), nullable=False),
