...
void main() {
  ...
  testWidgets('ResultadosView shows empty state when no results found', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('ResultadosView shows list of hotels when results found', (
    WidgetTester tester,
  ) async {
    final mockHotels = [
      Habitacion(
