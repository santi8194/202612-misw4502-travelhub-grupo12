...
const TRANSLATIONS: Record<LanguageCode, TranslationMap> = {
  es: {
    ...
    'bookingCart.loginRequiredToReserve': 'Debes iniciar sesión para reservar.',
    ...
    'bookingCartForm.title': 'Detalles del huésped principal',
    'bookingCartForm.name': 'Nombre(s)',
    'bookingCartForm.lastName': 'Apellido',
    'bookingCartForm.email': 'Email',
    'bookingCartForm.phone': 'Celular',
    'bookingCartForm.request': 'Solicitud detallada (Opcional)',
    'bookingCartForm.nameError': 'Ingresa un nombre válido (solo letras y espacios).',
    'bookingCartForm.lastNameError': 'Ingresa un apellido válido (solo letras y espacios).',
    'bookingCartForm.emailError': 'Ingresa un correo válido (ej: tu@ejemplo.com).',
    'bookingCartForm.phoneError': 'Debe incluir el código de país (ej: +573001112233).',
    'bookingCartForm.submitting': 'Confirmando reserva...',
    'bookingCartForm.continuePayment': 'Continuar con el pago',
    ...
    'cancelReservation.back': 'Volver',
    'cancelReservation.loading': 'Cargando información de cancelación...',
    'cancelReservation.notFoundTitle': 'Reserva no encontrada',
    'cancelReservation.notFoundBody': 'La reserva solicitada no existe o ya no está disponible.',
    'cancelReservation.unavailableTitle': 'Reserva no disponible',
    'cancelReservation.unavailableBody': 'No tienes permiso para ver esta reserva.',
    'cancelReservation.errorTitle': 'No pudimos cargar la cancelación',
    'cancelReservation.retry': 'Reintentar',
    'cancelReservation.completed': 'Cancelación completada',
    'cancelReservation.successTitle': 'Reserva cancelada',
    'cancelReservation.successBody': 'La reserva fue cancelada correctamente.',
    'cancelReservation.reference': 'Referencia de cancelación',
    'cancelReservation.expectedRefund': 'Reembolso esperado',
    'cancelReservation.refundStatus': 'Estado del reembolso',
    'cancelReservation.estimatedTime': 'Tiempo estimado',
    'cancelReservation.pending': 'Pendiente',
    'cancelReservation.notApplicable': 'No aplica',
    'cancelReservation.backHome': 'Volver al inicio',
    'cancelReservation.searchHotels': 'Buscar nuevos hoteles',
    'cancelReservation.processing': 'Cancelación en proceso',
    'cancelReservation.processingFallback': 'La cancelación espera confirmación del PMS.',
    'cancelReservation.referencePending': 'Se asignará al confirmar la solicitud',
    'cancelReservation.backToDetail': 'Volver al detalle',
    'cancelReservation.title': 'Cancelar reserva',
    'cancelReservation.subtitle': 'Revisa la política aplicable antes de confirmar la cancelación.',
    'cancelReservation.summaryTitle': 'Resumen de la reserva',
    'cancelReservation.hotel': 'Hotel',
    'cancelReservation.location': 'Ubicación',
    'cancelReservation.arrival': 'Fecha de llegada',
    'cancelReservation.departure': 'Fecha de salida',
    'cancelReservation.guests': 'Huéspedes',
    'cancelReservation.reservationNumber': 'Número de reserva',
    'cancelReservation.currentStatus': 'Estado actual',
    'cancelReservation.totalPaid': 'Total pagado',
    'cancelReservation.policyTitle': 'Política de cancelación',
    'cancelReservation.policy.free': 'Cancelación gratuita',
    'cancelReservation.policy.partial': 'Reembolso parcial',
    'cancelReservation.policy.none': 'No reembolsable',
    'cancelReservation.refundBreakdownTitle': 'Desglose de reembolso',
    'cancelReservation.paidAmount': 'Monto pagado',
    'cancelReservation.nonCancelableTitle': 'Esta reserva no puede cancelarse',
    'cancelReservation.nonCancelableBody': 'La reserva no puede cancelarse en este momento.',
    'cancelReservation.reasonLabel': 'Motivo de cancelación (opcional)',
    'cancelReservation.reasonPlaceholder': 'Ej. Cambio de planes',
    'cancelReservation.keepReservation': 'Mantener mi reserva',
    'cancelReservation.cancelReservation': 'Cancelar reserva',
    'cancelReservation.confirmTitle': 'Confirma la cancelación',
    'cancelReservation.confirmBody': 'Esta acción no se puede deshacer. Si cambias de opinión, deberás hacer una nueva reserva.',
    'cancelReservation.confirmTerms': 'Entiendo los términos de cancelación y la política de reembolso.',
    'cancelReservation.processingAction': 'Procesando...',
    'cancelReservation.confirmAction': 'Confirmar cancelación',
    'cancelReservation.status.hold': 'Hold',
    'cancelReservation.status.pending': 'Pendiente',
    'cancelReservation.status.confirmed': 'Confirmada',
    'cancelReservation.status.processing': 'Cancelación en proceso',
    'cancelReservation.status.cancelled': 'Cancelada',
    'cancelReservation.status.expired': 'Expirada',
    'cancelReservation.notAvailable': 'No disponible',
    'cancelReservation.error.processFallback': 'No fue posible procesar la cancelación. Intenta nuevamente.',
    'cancelReservation.error.loadFallback': 'No fue posible cargar la información de cancelación.',
    'cancelReservation.error.loginRequired': 'Debes iniciar sesión para continuar.',
    'cancelReservation.error.forbidden': 'No tienes permiso para cancelar esta reserva.',
    'cancelReservation.error.badRequest': 'La solicitud de cancelación no es válida.',
    'cancelReservation.error.conflict': 'La reserva no puede cancelarse en su estado actual.',
    'cancelReservation.error.unreachable': 'No fue posible contactar el servicio de cancelaciones.',
    'cancelReservation.error.server': 'Ocurrió un error técnico al procesar la solicitud.',
  ...
  en: {
    ...
    'bookingCart.loginRequiredToReserve': 'You must sign in to make a reservation.',
    ...
    'bookingCartForm.title': 'Main guest details',
    'bookingCartForm.name': 'First name(s)',
    'bookingCartForm.lastName': 'Last name',
    'bookingCartForm.email': 'Email',
    'bookingCartForm.phone': 'Phone number',
    'bookingCartForm.request': 'Detailed request (Optional)',
    'bookingCartForm.nameError': 'Enter a valid first name (letters and spaces only).',
    'bookingCartForm.lastNameError': 'Enter a valid last name (letters and spaces only).',
    'bookingCartForm.emailError': 'Enter a valid email (e.g. you@example.com).',
    'bookingCartForm.phoneError': 'It must include country code (e.g. +573001112233).',
    'bookingCartForm.submitting': 'Confirming reservation...',
    'bookingCartForm.continuePayment': 'Continue to payment',
    ...
    'cancelReservation.back': 'Back',
    'cancelReservation.loading': 'Loading cancellation details...',
    'cancelReservation.notFoundTitle': 'Booking not found',
    'cancelReservation.notFoundBody': 'The requested booking does not exist or is no longer available.',
    'cancelReservation.unavailableTitle': 'Booking unavailable',
    'cancelReservation.unavailableBody': 'You do not have permission to view this booking.',
    'cancelReservation.errorTitle': 'We could not load the cancellation',
    'cancelReservation.retry': 'Retry',
    'cancelReservation.completed': 'Cancellation completed',
    'cancelReservation.successTitle': 'Booking cancelled',
    'cancelReservation.successBody': 'The booking was cancelled successfully.',
    'cancelReservation.reference': 'Cancellation reference',
    'cancelReservation.expectedRefund': 'Expected refund',
    'cancelReservation.refundStatus': 'Refund status',
    'cancelReservation.estimatedTime': 'Estimated time',
    'cancelReservation.pending': 'Pending',
    'cancelReservation.notApplicable': 'Not applicable',
    'cancelReservation.backHome': 'Back to home',
    'cancelReservation.searchHotels': 'Search new hotels',
    'cancelReservation.processing': 'Cancellation in progress',
    'cancelReservation.processingFallback': 'Cancellation is waiting for PMS confirmation.',
    'cancelReservation.referencePending': 'It will be assigned once the request is confirmed',
    'cancelReservation.backToDetail': 'Back to details',
    'cancelReservation.title': 'Cancel booking',
    'cancelReservation.subtitle': 'Review the applicable policy before confirming cancellation.',
    'cancelReservation.summaryTitle': 'Booking summary',
    'cancelReservation.hotel': 'Hotel',
    'cancelReservation.location': 'Location',
    'cancelReservation.arrival': 'Arrival date',
    'cancelReservation.departure': 'Departure date',
    'cancelReservation.guests': 'Guests',
    'cancelReservation.reservationNumber': 'Booking number',
    'cancelReservation.currentStatus': 'Current status',
    'cancelReservation.totalPaid': 'Total paid',
    'cancelReservation.policyTitle': 'Cancellation policy',
    'cancelReservation.policy.free': 'Free cancellation',
    'cancelReservation.policy.partial': 'Partial refund',
    'cancelReservation.policy.none': 'Non-refundable',
    'cancelReservation.refundBreakdownTitle': 'Refund breakdown',
    'cancelReservation.paidAmount': 'Amount paid',
    'cancelReservation.nonCancelableTitle': 'This booking cannot be cancelled',
    'cancelReservation.nonCancelableBody': 'This booking cannot be cancelled right now.',
    'cancelReservation.reasonLabel': 'Cancellation reason (optional)',
    'cancelReservation.reasonPlaceholder': 'e.g. Change of plans',
    'cancelReservation.keepReservation': 'Keep my booking',
    'cancelReservation.cancelReservation': 'Cancel booking',
    'cancelReservation.confirmTitle': 'Confirm cancellation',
    'cancelReservation.confirmBody': 'This action cannot be undone. If you change your mind, you will need to make a new booking.',
    'cancelReservation.confirmTerms': 'I understand the cancellation terms and refund policy.',
    'cancelReservation.processingAction': 'Processing...',
    'cancelReservation.confirmAction': 'Confirm cancellation',
    'cancelReservation.status.hold': 'Hold',
    'cancelReservation.status.pending': 'Pending',
    'cancelReservation.status.confirmed': 'Confirmed',
    'cancelReservation.status.processing': 'Cancellation in progress',
    'cancelReservation.status.cancelled': 'Cancelled',
    'cancelReservation.status.expired': 'Expired',
    'cancelReservation.notAvailable': 'Not available',
    'cancelReservation.error.processFallback': 'Could not process the cancellation. Please try again.',
    'cancelReservation.error.loadFallback': 'Could not load cancellation details.',
    'cancelReservation.error.loginRequired': 'You must sign in to continue.',
    'cancelReservation.error.forbidden': 'You do not have permission to cancel this booking.',
    'cancelReservation.error.badRequest': 'The cancellation request is invalid.',
    'cancelReservation.error.conflict': 'The booking cannot be cancelled in its current status.',
    'cancelReservation.error.unreachable': 'Could not reach the cancellation service.',
    'cancelReservation.error.server': 'A technical error occurred while processing the request.',
