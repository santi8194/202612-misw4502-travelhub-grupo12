"""
Proposito del archivo: Define los modelos ORM (SQLAlchemy) para usuarios, roles y su relacion.
Rol dentro del microservicio: Representa la estructura de datos persistente en PostgreSQL o SQLite.
"""
...
class UserSession(Base):
    """Modelo de sesion persistida para soportar expiracion por inactividad y refresh tokens rotativos."""
